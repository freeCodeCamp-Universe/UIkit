...
<TypeSpecimen
  specimens={[
    ...
    },
    {
      token: '--fs-md',
      name: 'Body',
      sample: 'Readable prose. Mono metadata.',
      tag: 'p',
      meta: '18px · --lh-base'
    },
    {
      token: '--fs-sm',
      name: 'Small · Mono',
      sample: 'curl design.freecodecamp.org/llms.txt',
      tag: 'p',
      mono: true,
