---
layout: ../../layouts/FoundationsLayout.astro
title: Iconography
...
The first 5 icons cover Showcase's copy button, the theme toggle's validation
check, dismissable surfaces, search, and external links.
